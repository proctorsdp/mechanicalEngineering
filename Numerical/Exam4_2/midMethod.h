//
// Created by Steven Proctor on 5/3/17.
//

#ifndef EXAM4_2_MIDMETHOD_H
#define EXAM4_2_MIDMETHOD_H
...
private:
    ...
    double T_init = 10;                                         //initial temperature of bar
