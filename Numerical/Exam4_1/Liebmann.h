...
#ifndef EXAM4_1_LIEBMANN_H
#define EXAM4_1_LIEBMANN_H
...
private:
    ...
    double step;                        //step size of solver (cm)
    double centerTemp;                  //temperature of rod
    int rad;                            //radius of rod divided by step
    bool xtrHt = false;                 //true if heated rod is added
    int NODES;                          //number of nodes in the plate
    ...
    void extraHeat();                   //adds heated rod
    void fixCenter();                   //maintains constant heat at center of plate w/ rod
    void getCoordinate();               //allows the user to obtain information about a specific node
};
